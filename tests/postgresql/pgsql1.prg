...
// To run the test:
// pgsql1 --server <servername> --port <port> --uid <username> --pwd <userpassword> --database <databasename> --newtable --droptable
...
PROCEDURE Main()
   ...
   nConnection := sr_AddConnection(CONNECT_POSTGRES, "PGS=" + s_SERVER + ";PRT=" + s_PORT + ";UID=" + s_UID + ";PWD=" + s_PWD + ";DTB=" + s_DTB)
