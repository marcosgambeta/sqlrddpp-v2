// SQLRDD++
// test with ODBC/MySQL simulating CRUD
// To compile:
// hbmk2 odbcmysqlcrud
...
// To run the test:
// odbcmysqlcrud --driver <drivername> --server <servername> --port <port> --uid <username> --pwd <userpassword> --database <databasename> --options <options> --newtable --droptable
