...
const double divider5[19] = {1,    1E1,  1E2,  1E3,  1E4,  1E5,  1E6,  1E7,  1E8, 1E9,
...
static void fb_log_status5(FB_SESSION *session, const char *from)
{
...
// SR_FBCREATEDB5(cDatabaseName, cUserName, cPassword, nPageSize=default, cCharset=default,
...
static void sr_FBFieldGet5(PHB_ITEM pField, PHB_ITEM pItem, char *bBuffer,
...
// SR_FBLINEPROCESSED5(pSession, p2, aFields, lQueryOnly, nSystemID, lTranslate, aReturn) ->
  ...
  if (session != nullptr) {
    ...
    for (icol = 1; icol <= cols; icol++) {
      ...
      if (lIndex == 0) {
        ...
        if ((var->sqltype & 1) && (*var->sqlind < 0)) {
          sr_FBFieldGet5(hb_arrayGetItemPtr(pFields, icol), &temp, const_cast<char *>(""), 0,
          ...
          switch (dtype) {
          case IB_SQL_TEXT: {
            sr_FBFieldGet5(hb_arrayGetItemPtr(pFields, icol), &temp,
          ...
          case IB_SQL_TYPE_DATE: {
            ...
            sr_FBFieldGet5(hb_arrayGetItemPtr(pFields, icol), &temp, static_cast<char *>(data),
...
// SR_FBMORERESULTS5(pSession, @nValue) -> numeric
