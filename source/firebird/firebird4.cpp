...
HB_FUNC(SR_FBBEGINTRANSACTION4)
{
  GET_FB_SESSION(session, 1);
...
// SR_FBBeginTransaction(hEnv)
HB_FUNC(SR_FBCOMMITTRANSACTION4)
{
  GET_FB_SESSION(session, 1);
...
HB_FUNC(SR_FBROLLBACKTRANSACTION4)
{
  GET_FB_SESSION(session, 1);
...
HB_FUNC(SR_FBEXECUTEIMMEDIATE4)
{
  GET_FB_SESSION(session, 1);
