...
struct _SQLEXAREA
{
  ...
  bool bIsInsert;     // HB_TRUE if appending a new record
...
extern void odbcGetData(SQLHSTMT hStmt, PHB_ITEM pField, PHB_ITEM pItem, bool bQueryOnly, HB_ULONG ulSystemID,
