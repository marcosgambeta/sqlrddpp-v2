...
STATIC FUNCTION SR_SetEnvSQLRDD(oConnect)
   ...
   IF cStartingVersion < "MGMNT 1.02"
      ...
      oConnect:Commit()
      oConnect:Exec("CREATE INDEX " + cToolsOwner + "SR_MGMNTINDEX01 ON " + cToolsOwner + "SR_MGMNTINDEXES ( TABLE_ )", .F.)
      oConnect:Commit()
      oConnect:Exec("CREATE INDEX " + cToolsOwner + "SR_MGMNTINDEX02 ON " + cToolsOwner + "SR_MGMNTINDEXES ( IDXNAME_ )", .F.)
      oConnect:Commit()
      ...
      oConnect:Commit()
      oConnect:Exec("CREATE INDEX " + cToolsOwner + "SR_MGMNTTABLES01 ON " + cToolsOwner + "SR_MGMNTTABLES ( TABLE_ )", .F.)
      oConnect:Commit()
      ...
      oConnect:Commit()
      oConnect:Exec("CREATE INDEX " + cToolsOwner + "SR_MGMNTCONSTRAINTS01 ON " + cToolsOwner + "SR_MGMNTCONSTRAINTS ( SOURCETABLE_, CONSTRNAME_ )", .F.)
      oConnect:Commit()
      ...
      oConnect:Commit()
      oConnect:Exec("CREATE INDEX " + cToolsOwner + "SR_MGMNTCONSTRSRCCOLS01 ON " + cToolsOwner + "SR_MGMNTCONSTRSRCCOLS ( SOURCETABLE_, CONSTRNAME_, ORDER_ )", .F.)
      oConnect:Commit()
      ...
      oConnect:Commit()
      oConnect:Exec("CREATE INDEX " + cToolsOwner + "SR_MGMNTCONSTRTGTCOLS01 ON " + cToolsOwner + "SR_MGMNTCONSTRTGTCOLS ( SOURCETABLE_, CONSTRNAME_, ORDER_ )", .F.)
   ...
   IF cStartingVersion < "MGMNT 1.65"
      ...
      oConnect:Commit()
      oConnect:Exec("CREATE TABLE " + cToolsOwner + "SR_MGMNTLOCKS (LOCK_ CHAR(250) NOT NULL UNIQUE, WSID_ CHAR(250) NOT NULL, SPID_ NUMBER(8), LOGIN_TIME_ TIMESTAMP )", .F.)
      oConnect:Commit()
      oConnect:Exec("CREATE INDEX " + cToolsOwner + "SR_MGMNTLOCKS01 ON " + cToolsOwner + "SR_MGMNTLOCKS ( LOCK_, WSID_ )", .F.)
      oConnect:Commit()
      oConnect:Exec("CREATE INDEX " + cToolsOwner + "SR_MGMNTLOCKS02 ON " + cToolsOwner + "SR_MGMNTLOCKS ( WSID_, LOCK_ )", .F.)
      oConnect:Commit()
      oConnect:Exec("CREATE INDEX " + cToolsOwner + "SR_MGMNTLOCKS03 ON " + cToolsOwner + "SR_MGMNTLOCKS ( SPID_ )", .F.)
      oConnect:Commit()
      oConnect:Exec("UPDATE " + cToolsOwner + "SR_MGMNTVERSION SET VERSION_ = '" + HB_SR__MGMNT_VERSION + "'")
      oConnect:Commit()
      cRet := HB_SR__MGMNT_VERSION
   ...
   IF cStartingVersion < "MGMNT 1.50"
      ...
      oConnect:Commit()
      oConnect:Exec("CREATE INDEX " + cToolsOwner + "SR_MGMNTLANG01 ON " + cToolsOwner + "SR_MGMNTLANG ( TABLE_, COLUMN_ )", .F.)
      oConnect:Commit()
      oConnect:Exec("UPDATE " + cToolsOwner + "SR_MGMNTVERSION SET VERSION_ = '" + HB_SR__MGMNT_VERSION + "'")
      oConnect:Commit()
      cRet := HB_SR__MGMNT_VERSION
   ...
   IF cStartingVersion < "MGMNT 1.72"
      ...
      oConnect:Commit()
      oConnect:Exec("CREATE INDEX " + cToolsOwner + "SR_MGMNTLOGCHG01 ON " + cToolsOwner + "SR_MGMNTLOGCHG ( SPID_, WPID_ )", .F.)
      oConnect:Commit()
      oConnect:Exec("CREATE INDEX " + cToolsOwner + "SR_MGMNTLOGCHG02 ON " + cToolsOwner + "SR_MGMNTLOGCHG ( APPUSER_, SPID_ )", .F.)
      oConnect:Commit()
      oConnect:Exec("CREATE INDEX " + cToolsOwner + "SR_MGMNTLOGCHG03 ON " + cToolsOwner + "SR_MGMNTLOGCHG ( TIME_, SITE_ )", .F.)
      oConnect:Commit()
      oConnect:Exec("CREATE INDEX " + cToolsOwner + "SR_MGMNTLOGCHG04 ON " + cToolsOwner + "SR_MGMNTLOGCHG ( TYPE_, TIME_ )", .F.)
      oConnect:Commit()
#endif
