...
HB_FUNC( ORACLEGETBINDDATA2)
{
   ...
   POCI_ORASESSION p = (POCI_ORASESSION) hb_itemGetPtr(hb_param(1, Harbour::Item::POINTER));
   int iPos;
...
{
   OCI_ORASESSION * p = (OCI_ORASESSION *) hb_itemGetPtr(hb_param(1, Harbour::Item::POINTER));
