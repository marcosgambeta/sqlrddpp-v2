...
{
   SQLHSTMT hStmt;
   SQLHDBC hdbc = static_cast<SQLHDBC>(hb_parptr(1));
...
HB_FUNC( SR_FREESTM )
{
   SQLHSTMT p = static_cast<SQLHSTMT>(hb_parptr(1));
...
HB_FUNC( SR_FETCH )
{
   SQLHSTMT hstmt = static_cast<SQLHSTMT>(hb_parptr(1));
   RETCODE wResult;
...
HB_FUNC( SR_ODBCWRITEMEMO )
{
   ...
   hDbc = static_cast<SQLHDBC>(hb_parptr(1));
